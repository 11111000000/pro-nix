...
[extra]
tldr = "Все 0 shell-скриптов под scripts/ и bin/. Первая непустая строка каждого показана как one-line purpose."
+++

# Скрипты

<span class="gen-badge">auto-gen</span> Сгенерировано 2026-06-16 из `scripts/*` и `bin/*`.
...
**Всего:** 0 скриптов (0 в `scripts/`, 0 в `bin/`).
