...
[extra]
tldr = "Все ~65 пользовательских `defcustom` knob'ов в pro-*.el модулях, сгруппированных по `defgroup`."
+++

# defcustom knobs

<span class="gen-badge">auto-gen</span> Сгенерировано 2026-06-16 из `emacs/base/modules/pro-*.el`.
...
**Всего knob'ов:** 65  ·  **Всего групп:** 20  ·  **Файлов просканировано:** 64
