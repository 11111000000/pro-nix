...
in
{
  options.pro.emacs = {
    ...
    providedPackages = lib.mkOption {
      ...
      default = [ "magit" "consult" "vertico" "orderless" "marginalia" "gptel" "consult-dash" "dash-docs" "consult-eglot" "consult-yasnippet" "corfu" "cape" "kind-icon" "avy" "expand-region" "yasnippet" "projectile" "treemacs" "consult-projectile" "elfeed" "eglot" "rainbow-delimiters" "nix-mode" "markdown-mode" "mmm-mode" "org" "ob-mermaid" "vterm" "multi-vterm" "eshell-toggle" "ace-window" "undo-tree" "haskell-mode" "haskell-snippets" "which-key" "which-key-posframe" "eldoc-box" "keyfreq" "helpful" "popper" "buffer-expose" "buffer-move" "embark" "embark-consult" "exwm" "xelb" "agent-shell" "acp" "telega" "transient" "visual-fill-column" "pro-tabs" "goto-chg" ];
    };
