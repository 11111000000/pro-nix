...
lib.mkIf cfg.gui.enable {
  ...
  home.file.".config/pro/exwm-session" = {
    text = ''
      #!/usr/bin/env bash
      # This is the Emacs-side counterpart to the system EXWM session entry.
      # It prepares the user session, imports the graphical environment and
      # starts Emacs under systemd scope so resource limits stay explicit.
