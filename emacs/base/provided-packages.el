...
(setq pro-packages-provided-by-nix
      '(magit consult vertico orderless marginalia gptel consult-dash dash-docs consult-eglot consult-yasnippet corfu cape kind-icon avy expand-region yasnippet projectile treemacs vterm ace-window))
